...
localStorage.setItem( "flor@gmail.com",JSON.stringify({email : "flor@gmail.com" , password : "12345678" , type : 'Member' }));
localStorage.setItem( "miriam@gmail.com",JSON.stringify({email : "miriam@gmail.com", password : "12345678" , type : 'Publico' }));

var agentes = [

	{ id : 0 , tipo: 'fisico', url : 'bjstdmngbgr01.thoughtworks.com' , estado : 'idle' , direccionIP: '192.168.1.2' , directorio : '/var/lib/cruise-agent', recursos : [{name:'Ubuntu'},{name:'firefox'},{name:'core-duo'}]},
	{ id : 1 , tipo: 'fisico', url : 'bjstdmngbgr02.thoughtworks.com' , estado : 'building' , direccionIP: '192.168.1.3' , directorio : '/var/lib/cruise-agent', recursos : [{name:'Ubuntu'},{name:'mysql'},{name:'core-duo'}]},
